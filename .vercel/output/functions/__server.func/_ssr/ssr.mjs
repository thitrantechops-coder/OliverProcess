...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-KtovdYOT.mjs");
...
var manifest = { "e1fb2f96d202716648e1a91e623c75552f0ee672ea63cb5bcdc249942db5d712": {
	functionName: "askOliver_createServerFn_handler",
	importer: () => import("./ask-oliver-BiHCAOhi.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-6qbtlUd4.mjs").then((n) => n.t),
